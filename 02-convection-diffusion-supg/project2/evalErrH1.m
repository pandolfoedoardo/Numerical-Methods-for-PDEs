...
% Estraiamo i nodi e le coordinate del triangolo
    ...
    y = coord(n, 2);
        ...
        % =========================================================
        % Troviamo il baricentro del triangolo
    xb = (x(1) + x(2) + x(3)) / 3;
    yb = (y(1) + y(2) + y(3)) / 3;
    ...
    grad_ex = grad_ureal(xb, yb); 
        ...
        % NOTA: Assumo che Bloc e Cloc siano i coefficienti b_i e c_i standard.
        %
    % Calcoliamo il gradiente NUMERICO (costante sul triangolo)
        % ATTENZIONE AGLI INDICI: Bloc(nodo_locale, elemento_i)
